...
def validatePathArgs(argPath, argDescStr):
    if not argPath:
        ...
        print("{s0} path is a file. Must be directory. {s1}".format(s0=argDescStr,s1=argPath))
...
def setMakePaths(trainPath,validPath,testPath,resultPathParent):
    ...
    paths = [cwdPath,trainPath,validPath,copyFromTestPath,copyToTestPath,pccdTestImgPath,pccdTestImgPath,pccdTestImgClssPath,resultPath]
